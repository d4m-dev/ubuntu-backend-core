...
# bash /mnt/sdcard/ubuntu-backend-core/scripts/auto_start.sh
...
alias deploy='python3 /mnt/sdcard/deploy.py'

alias backend='bash /mnt/sdcard/ubuntu-backend-core/scripts/auto_start.sh'
alias avatar='~/myenv/bin/python3 /mnt/sdcard/avatar_server/run_server.py'
