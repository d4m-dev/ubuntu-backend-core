...
alias maychu='python3 /mnt/sdcard/ubuntu-backend-core/start_all.py'
alias avatar='~/myenv/bin/python3 /mnt/sdcard/ubuntu-backend-core/avatar_server/run_server.py'
